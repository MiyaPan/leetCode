...
import { isBalanced2 } from '../../src/interviewQuestion/is-balanced';
...
describe('isBalanced2', () => {
    ...
    */
    ...
    test("tree return true", () => {
        expect(isBalanced2(tree)).toEqual(true);
    });
    ...
    */
    ...
    test("tree return true", () => {
        expect(isBalanced2(tree1)).toEqual(false);
    });
    ...
    */
    ...
    test("tree return true", () => {
        expect(isBalanced2(tree2)).toEqual(false);
    });
});