import { maxSubArray, divideAndConquer, dynamicProgramming, dynamicProgramming2 , maxSubArray_2, maxSubArray_3} from '../../src/easy/max-sub-array';
...
describe('maxSubArray_2', () => {
    // test('[1,1,2] return 4', () => {
    //     expect(maxSubArray_2([1,1,2])).toEqual(4);
    // });

    // test('[0,0,-1,1,1,2,-2,3,3,-4] return 8', () => {
    //     expect(maxSubArray_2([0,0,-1,1,1,2,-2,3,3,-4])).toEqual(8);
    // });

    // test('[0] return 0', () => {
    //     expect(maxSubArray_2([0])).toEqual(0);
    // });

    // test('[-2,1,-3,4,-1,2,1,-5,4] return 6', () => {
    //     expect(maxSubArray_3([-2,1,-3,4,-1,2,1,-5,4])).toEqual(6);
    // });
    // maxSubArray_3 是错的
    // test('[-2,1,-3,4,-1,2,1,-5,4] return 6', () => {
    //     expect(maxSubArray_3([8,-19,5,-4,20])).toEqual(21);
    // });

    // test('[-2,1] return 1', () => {
    //     expect(maxSubArray_2([-2,1])).toEqual(1);
    // });

    // test('[-1,0,-2] return 0', () => {
    //     expect(maxSubArray_2([-1,0,-2])).toEqual(0);
    // });
});